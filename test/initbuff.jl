@testset "initbuff" begin
  ...
  @testset "nearest" begin
    ...
    buff, mask = initbuff(data1D, grid, NearestInit())
    ...
    buff, mask = initbuff(data2D, grid, NearestInit())
    ...
    buff, mask = initbuff(data2D, pset, NearestInit())
  ...
  @testset "explicit" begin
    ...
    buff, mask = initbuff(data, grid, ExplicitInit())
    ...
    buff, mask = initbuff(data, grid, ExplicitInit(91:100))
    ...
    buff, mask = initbuff(data, grid, ExplicitInit(1:3, 98:100))
