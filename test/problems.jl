@testset "Problems" begin
  ...
  @testset "Estimation" begin
    ...
    if visualtests
      plt = plot(problem2D,ms=2)
      @test_reference "data/estimation.png" asimage(plt)
    end
  end
  ...
  @testset "Simulation" begin
    ...
    if visualtests
      plt = plot(problem2D,ms=2)
      @test_reference "data/simulation.png" asimage(plt)
    end
  end
  ...
  @testset "Learning" begin
    ...
    if visualtests
      plt = plot(problem,ms=2)
      @test_reference "data/learning.png" asimage(plt)
    end
  end
end
