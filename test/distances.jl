@testset "Distances" begin
  ...
  gslib = Ellipsoidal([50.,25.,5.], [30.,-30.,30.], convention=:GSLIB)
  tait = Ellipsoidal([25.,50.,5.], [-π/6,-π/6,π/6], convention=:TaitBryanIntr)
  euler = Ellipsoidal([50.,25.,5.], [-deg2rad(78),-deg2rad(41),-deg2rad(50)], convention=:EulerIntr)
  lpf = Ellipsoidal([50.,25.,5.], [78.,41.,50.], convention=:Leapfrog)
  dm = Ellipsoidal([50.,25.,5.], [78.,41.,50.], convention=:Datamine)
  ...
  xtait = Ellipsoidal([50.,25.,5.], [π,0,π/2], convention=:TaitBryanExtr)
  xeuler = Ellipsoidal([50.,25.,5.], [-π/2,-π/2,-π/2], convention=:EulerExtr)
